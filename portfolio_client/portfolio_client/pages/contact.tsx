...
const Contact = () => {
    ...
    return (
        <Layout
            title='Andreas Deris contact page'
            desc='If you have questions or need help you can contact me at andreasdesir618@gmail.com | Or Send a Message through the form.'>
                ...
                <Container
                    ...
                    <Box
                        ...
                        <Box sx={{
                            ...
                            <ContactBox 
                            href='mailto:andreasdesir618@gmail.com'
                            target='_blank'
                            t1='Get in touch' t2='Email Address' t3='andreasdesir618@gmail.com'/>
                            <ContactBox 
                            href={``}
                            target='_blank'
                            t1='Location'
                             t2='Currently living in' t3='Europe'/>
                            <ContactBox 
                            target='_blank'
                            href={'https://wa.me/+33643816504'}
                            t1='Contact Directly ' t2='Phone Number' t3='+33643816504'/>
                        </Box>
                    </Box>
                    <SocialMedia/>
