...
const Hero = () => {
            ...
            <Grid
                ...
                <Grid item xs={12} sm={10} md={8} lg={7}>
                    <Box ref={ref}>
                        ...
                        The place where your <span style={{
  background: 'linear-gradient(to right, #4334eb, #f66767)',
  ...
  business
                        ...
                        <Typography
                           ...
                           Hey there! Call me Andreas desir. I enjoy creating kickass websites and web/mobile apps, ones that suit your desires and needs using latest technologies and cleanest design patterns. 
                        </Typography>
                    ...
                    <Box
                        ...
                        <Box
                            ...
                            <Box
                                ...
                                overflow: 'hidden',
                                opacity: 0,
                                background: 'linear-gradient(to right, #4334eb, #e05fa2)'
                            }}>
                                <Typography
                                    sx={{
                                    fontWeight: '300',
